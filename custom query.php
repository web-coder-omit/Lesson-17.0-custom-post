 ...
 * Description: This plugin make for pratice wich is "custom post".
 * Version:     0.1.0
 * License:     GPL-2.0+
...
function cptui_register_my_cpts() {
	...
	$labels = [
		"name" => esc_html__( "computers", "hello-elementor" ),
		"singular_name" => esc_html__( "Computer", "hello-elementor" ),
	];

	$args = [
		"label" => esc_html__( "computers", "hello-elementor" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"hierarchical" => false,
		"can_export" => false,
		"rewrite" => [ "slug" => "computer", "with_front" => true ],
		"query_var" => true,
